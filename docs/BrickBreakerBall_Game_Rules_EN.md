# BrickBreakerBall - Game Rules & Sprite Reference (English)
...
## 3. Ball System
### Sizes
- **Small** - Small / Shrink size. About half-size in the supplied rules; harder to return, but better for narrow gaps.
